...
def test_reward_block_proposal(astra):
    ...
    assert reward_amount_diff + commission_amount_diff <= supply_diff * 98.0 / 100 + 1000
    ...
    total_change = total_validator2_change + total_validator1_change
    assert total_diff > supply_diff + 10000
