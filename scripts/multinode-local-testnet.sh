...
astrad tendermint show-node-id --keyring-backend=test --home=.testnets/node2/astrad

# change config.toml values

# validator1
sed -i -E 's|allow_duplicate_ip = false|allow_duplicate_ip = true|g' .testnets/node0/astrad/config/config.toml
sed -i -E 's|tcp://0.0.0.0:40002|tcp://0.0.0.0:40000|g' .testnets/node0/astrad/config/config.toml
sed -i -E 's|tcp://0.0.0.0:50002|tcp://0.0.0.0:50000|g' .testnets/node0/astrad/config/config.toml
# validator2
...
sed -i -E 's|tcp://0.0.0.0:40002|tcp://0.0.0.0:40001|g' .testnets/node1/astrad/config/config.toml
sed -i -E 's|tcp://0.0.0.0:50002|tcp://0.0.0.0:50001|g' .testnets/node1/astrad/config/config.toml
