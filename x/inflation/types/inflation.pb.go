...
func init() {
	...
	proto.RegisterType((*ExponentialCalculation)(nil), "astra.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("astra/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
